  ...
  return (
    <div>
      <div class="container my-24 mx-auto md:px-20">
        <section class="mb-32">
          <h2 class="mb-16 text-center text-2xl text-black font-bold">Latest articles</h2>
          ...
          <div class="mb-16 flex flex-wrap">
            ...
            <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
              <h3 class="mb-4 text-2xl font-bold text-black">That's the news!</h3>
          ...
          <div class="mb-16 flex flex-wrap lg:flex-row-reverse">
            ...
            <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pr-6">
              <h3 class="mb-4 text-2xl font-bold text-black">Exhibition in Paris</h3>
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
              <h3 class="mb-4 text-2xl font-bold text-black">Stock market boom</h3>
